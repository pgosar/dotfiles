...
PACMAN_PACKAGES=(
    ...
    base base-devel bash-completion git wget which unzip unrar jq rsync ripgrep fd less
    man-db man-pages texinfo tldr python python-pip python-pipx python-gobject nodejs npm
