return {
	...
	config = function()
		...
		dashboard.section.buttons.val = {
			dashboard.button(
				"e",
				icons.alpha.new_file .. "  New file",
				function() require("core.utils.utils").create_new_file() end
			),
			...
			dashboard.button(
				"l",
				icons.alpha.last_session .. "  Open last session",
				function() require("persistence").load({ last = true }) end
			),
			dashboard.button(
				"o",
				icons.alpha.open_session .. "  Open session",
